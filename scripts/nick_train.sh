...
OMP_NUM_THREADS=$N_CPUS PYTHONPATH=/home/hk-project-p0021769/hgf_grc7525/repo/Masterproject-plankton-dinov2 torchrun \
	...
	crops.local_crops_number=4 crops.use_ch_patch_embed=false train.in_chans=1 optim.base_lr=0.0005 crops.use_variable_channels=false train.grayscale=true \