...
def get_bin_data(csv_path, output_dir: str, max_bins: int | None = None, start_bin: str | None = None, blacklisted_tags: list[str] = [], blacklisted_sample_types: list[str] = []):
    """
    ...
    with open(csv_path, 'r') as file:
        ...
        for i,line in enumerate(csv_reader):
            ...
            if line["dataset"]  == "mvco":
                ...
                if line["skip"] == "1" or any(tag in blacklisted_tags for tag in all_tags) or line["sample_type"] != "" and line["sample_type"] in blacklisted_sample_types or line["pid"] in blacklisted_mvco_bins:
...
def main(args):
    ...
    bins = get_bin_data(args.csv_path, output_dir=args.output_dir, start_bin=args.start_bin, blacklisted_sample_types=args.blacklisted_sample_types, blacklisted_tags=args.blacklisted_tags, max_bins=args.max_bins )  # gets all bins not present in the folder
